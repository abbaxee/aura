    ...
    <v-container fluid class="mt-3 mb-0">
      <v-layout wrap align-center justify-center row fill-height class="my-0">
        <v-flex xs12 md10 class="my-0">
          ...
          >Our lineup of big thinkers and even bigger doers</p>
          <p
          ...
          <p
            ...
            style="font-size:110%"
          >Our goal is to organize space to connect the best industry experts with Lafia audience to boost development of IT. And Our Core Team is:</p>
        </v-flex>
      </v-layout>
    </v-container>
